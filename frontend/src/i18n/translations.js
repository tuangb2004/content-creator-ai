export const translations = {
  en: {
    ...
    pricing: {
      ...
      plans: {
        ...
        business: {
          ...
          billedYearly: 'Billed yearly. ',
          cta: 'Contact Sales',
          creditsMonthly: '600 Monthly Credits',
          creditsYearly: '7,200 Yearly Credits',
          features: [
    ...
    dashboard: {
      ...
      home: {
        mainHeading: 'Bring your imagination to life.',
        banner: 'Nano Banana Pro and the latest Seedream models are ready',
        history: 'History',
        popularFeatures: 'Popular Features',
        recentCreations: 'Recent Creations',
        trendingTikTok: 'Trending on TikTok',
        visualInspiration: 'Visual Inspiration',
        viewAll: 'View All',
        autoModeDesc: 'Auto mode will select the optimal ratio based on your description.',
        uploadFromComputer: 'Upload from computer',
        chooseFromAssets: 'Choose from Assets',
        more: 'More',
        importFromLink: 'Import from product link',
        uploadFromDropbox: 'Upload from Dropbox',
        uploadFromPhone: 'Upload from phone',
        scanQr: 'Scan QR code to upload',
        scanQrDesc: 'Use your phone camera to scan the code and upload images',
        noHistory: 'No activity history',
        placeholderVideo: 'Describe the video you want to create. Add links, images, or documents for more accurate results.',
        placeholderImage: 'Describe the image you want to design and use "/" to mark text to add',
        placeholderText: 'Describe the content you want to write or edit...',
      ...
      billing: {
        ...
        subtitle: 'Scale your creativity with our flexible credit plans.',
        monthly: 'Monthly',
        yearly: 'Yearly',
        save20: 'Save 20%',
        bestValue: 'Best Value',
        ...
        topUpSubtitle: 'Top up your account with additional credits',
        buyNow: 'Buy Now',
        ...
        business: {
          ...
          monthlyCredits: '25,000 Monthly Credits',
          yearlyCredits: '300,000 Yearly Credits',
      ...
      uploadModal: {
        ...
        support: 'Supports: Images (JPG, PNG, GIF, WebP), Video (MP4, WebM, MOV), PDF, Text (TXT, MD, CSV)',
        maxSize: 'Max 20MB per file',
        selectedFiles: 'Selected files:',
        cancel: 'Cancel',
        upload: 'Upload',
        uploading: 'Uploading...',
        fileTooLarge: 'File {name} exceeds 20MB',
        uploadSuccess: 'Uploaded {count} files successfully',
      ...
      imageStudio: {
        title: 'Image Studio',
        marketingHeading: 'Elevate your marketing visuals',
        aiDesign: 'AI Design',
      ...
      assets: {
        ...
        modified: 'Modified',
        upload: 'Upload',
        noCreations: 'No videos or images yet.',
        startCreating: 'Start creating to see your content here.',
        noUploads: 'No files uploaded yet',
        uploadToUse: 'Upload files to use when creating content',
        selected: 'Selected',
        clear: 'Clear selection',
        confirmDelete: 'Are you sure you want to delete {count} selected items?',
        deleteError: 'An error occurred while deleting items.',
        newCreation: 'New Creation',
      },
      selectFile: {
        title: 'Select file from Assets',
        noFiles: 'No files uploaded yet',
        uploadFirst: 'Please upload files in Assets first',
      },
      assets: {
        title: "'s space",
        creations: 'Creations',
        ...
        modified: 'Modified',
        upload: 'Upload',
        noCreations: 'No exported videos or images yet.',
        startCreating: 'Start creating content to see your assets here.',
        noUploads: 'No files uploaded yet',
        uploadToUse: 'Upload files to use them in your creations',
        selected: 'selected',
        clear: 'Clear',
        confirmDelete: 'Are you sure you want to delete {count} selected items?',
        deleteError: 'An error occurred while deleting items.',
      ...
      models: {
        nanoPro: 'Pro image quality',
        nano: 'Fast & efficient',
        sdxl: 'High quality stable diffusion',
        groq: 'Super fast & smart',
        geminiFlash: 'Fastest & smartest model',
        geminiNextGen: 'Next-gen performance',
        geminiPro: 'Reasoning & complexity',
        nanoVideo: 'Smooth generation',
        runway: 'Cinematic realism',
      },
      chat: {
        back: 'Back',
        history: 'Chat History',
        startChat: 'Start a conversation with Creator AI',
        ...
        newCreation: 'New Creation',
        aiTalkingPhoto: 'AI talking photo',
        avatarVideo: 'Avatar video',
        productPhoto: 'Product photo',
        vibeMarketing: 'Vibe marketing',
        useNow: 'Use now',
      },
      greeting: {
    ...
    billing: {
      ...
      starter: {
        ...
        credits: '5',
        features: {
          credits: '5 Free Credits (One-time)',
          tools: 'Gemini 3 Flash Access',
          seo: 'Create 1 AI Image (Trial)',
      ...
      pro: {
        ...
        features: {
          ...
          images: 'Up to 3 Videos or 12 Pro Images',
      ...
      agency: {
        ...
        features: {
          credits: '300 Monthly Credits',
          unlimited: 'Up to 10 Videos or 37 Pro Images',
      ...
      business: {
        ...
        credits: '600',
        features: {
          monthlyCredits: '600 Monthly Credits',
          yearlyCredits: '7,200 Yearly Credits',
          unlimited: 'Unlimited team members',
          support: 'Priority support 24/7',
          integrations: 'Custom integrations',
          manager: 'Dedicated account manager',
    ...
    dashboard: {
      videoGen: {
        ...
        quickCut: 'Quick Cut',
        videoEditor: 'Video Editor',
        history1: 'Wool-felt winter village',
        history2: 'TikTok marketing video',
        history3: 'Santa shop showcase',
      },
      home: {
        banner: 'New AI features available! Experience the power of Gemini 2.5',
        mainHeading: 'What will you create today?',
        placeholderVideo: 'Describe the video you want to generate...',
        placeholderImage: 'Describe the image you want to generate...',
        placeholderText: 'Topic or idea for text content...',
        formHintImage: 'Create images from text and components',
        formHintVideo: 'Create video from text and assets',
        formHintText: 'Create text content from your description',
        uploadFromComputer: 'Upload from Computer',
        chooseFromAssets: 'Choose from Assets',
        more: 'More',
        ...
        uploadFromPhone: 'Upload from Phone',
        scanQr: 'Scan QR Code',
        scanQrDesc: 'Scan to upload photos directly from your phone',
        schedule: 'Schedule',
        recentUploads: 'Recent uploads',
        aspectRatio: 'Aspect Ratio',
        auto: 'Auto',
        ...
        recentCreations: 'Recent Creations',
        viewAll: 'View All',
        autoRatioDesc: 'Auto mode will select the optimal aspect ratio based on your description.',
      },
      notificationDropdown: {
        ...
        loading: 'Loading...',
        noActivity: 'No activity yet',
        noNotifications: 'Notifications will appear here.',
        groups: {
          today: 'Today',
          thisWeek: 'This week',
          previous: 'Previous',
        ...
        videoStatus: {
          ...
          pending: 'Queued video...',
          failed: 'Failed to create video',
          completed: 'Video created',
        },
        actions: {
      ...
      imageStudio: {
        ...
        bigSale: 'BIG SALE',
        rosifyMagic: 'Rosify magic',
        inspiration1Title: '"Nested Learning: A New Framework for Deep Learning"',
        inspiration1Desc: 'An Overview of Key Concepts and Applications',
        googleResearch: 'Google Research',
      },
      inspiration: {
        weeklyTopCreators: 'Weekly Trending',
        industry: 'Industry',
        duration: 'Duration',
      ...
      analytics: {
        ...
        mainHeading: 'One dashboard for your posts across social media platforms.',
        byAccount: 'By account',
        byAccountDesc: 'Track key engagement metrics for each social account.',
        byPost: 'By post',
        byPostDesc: 'Break data down by individual stories, posts, and reels.',
        compare: 'Aggregate and compare',
        compareDesc: 'Easily aggregate data and compare post performances.',
        authorize: 'Authorize',
        summary: 'Summary',
        followers: 'Followers',
      ...
      publisher: {
        title: 'Publisher',
        freeForNow: 'Free for now',
        mainHeading: 'Manage your posts across social platforms in one place.',
        postMore: 'Post more, grow more',
        postMoreDesc: 'Everything you need to create, edit, and publish posts to build your brand on social media.',
        workflow: 'Streamline your workflow',
        workflowDesc: 'Manage all of your social media content in one place.',
        saveTime: 'Save time',
        saveTimeDesc: 'Schedule to automatically post content whenever you want.',
        authorize: 'Authorize',
  ...
  vi: {
    ...
    pricing: {
      ...
      plans: {
        ...
        pro: {
          ...
          credits: '100 Tín dụng Hàng tháng',
          features: [
            'Gemini 3 Pro Reasoning',
        ...
        agency: {
          ...
          credits: '300 Tín dụng Hàng tháng',
          features: [
        ...
        business: {
          ...
          creditsMonthly: '600 Tín dụng Hàng tháng',
          creditsYearly: '7.200 Tín dụng Hàng năm',
          features: [
    ...
    dashboard: {
      ...
      nav: {
        ...
        imageStudio: 'Studio Hình Ảnh',
        avatars: 'Avatar & Giọng Nói',
        analytics: 'Phân Tích',
        publisher: 'Xuất Bản',
        smartCreation: 'Sáng Tạo Thông Minh',
        assets: 'Tài Nguyên',
      },
      profile: {
      ...
      home: {
        mainHeading: 'Hãy biến trí tưởng tượng của bạn thành hiện thực.',
        banner: 'Nano Banana Pro và các mô hình Seedream mới nhất đã sẵn sàng',
        history: 'Lịch sử',
        ...
        chooseFromAssets: 'Chọn từ Tài nguyên',
        more: 'Thêm',
        importFromLink: 'Nhập từ liên kết sản phẩm',
        uploadFromDropbox: 'Tải lên từ Dropbox',
        uploadFromPhone: 'Tải lên từ điện thoại',
        scanQr: 'Quét mã QR để tải lên',
        scanQrDesc: 'Sử dụng camera điện thoại để quét mã và tải ảnh lên',
        noHistory: 'Chưa có lịch sử hoạt động',
        placeholderVideo: 'Hãy mô tả video bạn muốn tạo. Thêm liên kết, hình ảnh hoặc tài liệu để có kết quả chính xác hơn.',
        placeholderImage: 'Mô tả hình ảnh bạn muốn thiết kế và sử dụng "/" để đánh dấu văn bản cần thêm',
        placeholderText: 'Mô tả nội dung bạn muốn viết hoặc chỉnh sửa...',
        formHintImage: 'Tạo hình ảnh từ văn bản và thành phần',
        formHintVideo: 'Tạo video từ văn bản và tài liệu',
        formHintText: 'Tạo nội dung văn bản từ mô tả của bạn',
        aspectRatio: 'Tỷ lệ khung hình',
        ratio: 'Tỉ lệ',
        auto: 'Tự động',
        schedule: 'Lên lịch',
        recentUploads: 'Tệp gửi lên gần đây',
      },
      profileSettings: {
        title: 'Cài đặt hồ sơ',
        subtitle: 'Quản lý thông tin cá nhân và preferences của bạn.',
        profilePhoto: 'Ảnh đại diện',
        acceptedFileTypes: 'Hỗ trợ: png, jpg. Tối đa: 2MB',
        ...
        bioPlaceholder: 'Giới thiệu về bản thân bạn...',
        saving: 'Đang lưu...',
        saveChanges: 'Lưu thay đổi',
        notifications: 'Thông báo',
        productUpdates: 'Cập nhật sản phẩm',
        productUpdatesDesc: 'Nhận tin tức về các công cụ và tính năng mới.',
        projectCompleted: 'Dự án hoàn thành',
        projectCompletedDesc: 'Gửi email cho tôi khi quá trình tạo nội dung dài kết thúc.',
        saveNotifications: 'Lưu cài đặt thông báo',
        avatarUploaded: 'Ảnh đại diện đã được tải lên!',
        avatarRemoved: 'Ảnh đại diện đã được gỡ bỏ!',
        profileUpdated: 'Cập nhật hồ sơ thành công!',
        notificationsUpdated: 'Cài đặt thông báo đã được lưu!',
      },
      billing: {
        // Updated billing section located below
      },
      uploadModal: {
        title: 'Tải lên file',
        dragDrop: 'Kéo thả file vào đây hoặc',
        chooseFromComputer: 'Chọn file từ máy tính',
        support: 'Hỗ trợ: Ảnh (JPG, PNG, GIF, WebP), Video (MP4, WebM, MOV), PDF, Text (TXT, MD, CSV)',
        maxSize: 'Tối đa 20MB mỗi file',
        selectedFiles: 'Files đã chọn:',
        cancel: 'Hủy',
        upload: 'Tải lên',
        uploading: 'Đang tải lên...',
        fileTooLarge: 'File {name} vượt quá 20MB',
        uploadSuccess: 'Đã tải lên {count} file thành công',
        uploadFailed: 'Lỗi khi tải lên file',
      },
      videoGen: {
        ...
        avatarVideo: 'Video Avatar',
        talkingPhoto: 'Ảnh nói chuyện AI',
        productShowcase: 'Trình diễn sản phẩm',
        removeBackground: 'Xóa nền',
        quickCut: 'Cắt nhanh',
        videoEditor: 'Trình biên tập video',
        history1: 'Làng mùa đông bằng len',
        history2: 'Video tiếp thị TikTok',
        history3: 'Trưng bày cửa hàng ông già Noel',
      },
      imageStudio: {
        title: 'Studio hình ảnh',
        marketingHeading: 'Nâng tầm hình ảnh marketing',
        aiDesign: 'Thiết kế AI',
        aiBackground: 'Nền AI',
        removeBackground: 'Xóa nền',
        designLayout: 'Bố cục thiết kế',
        quickTools: 'Công cụ nhanh',
        upscale: 'Tăng chất lượng ảnh',
        imageEditor: 'Trình biên tập ảnh',
        findInspiration: 'Tìm cảm hứng',
        allImages: 'Tất cả ảnh',
        productPoster: 'Poster sản phẩm',
        textPoster: 'Poster chữ',
        newUpdate: 'Cập nhật mới',
        bigSale: 'ĐẠI HẠ GIÁ',
        rosifyMagic: 'Phép thuật Rosify',
        inspiration1Title: '"Học Lồng Ghép: Một Khung Mới cho Deep Learning"',
        inspiration1Desc: 'Tổng quan về các khái niệm chính và ứng dụng',
        googleResearch: 'Nghiên cứu Google',
      },
      inspiration: {
        weeklyTopCreators: 'Xu Hướng Hàng Tuần',
        industry: 'Ngành',
        duration: 'Thời lượng',
        ...
        videoTemplates: 'Video',
        imageTemplates: 'Hình ảnh',
        writingTemplates: 'Văn bản',
        favorites: 'Đã lưu',
        trending: 'Thịnh hành',
        tryThisStyle: 'Thử phong cách này',
        use: 'Sử dụng',
      },
      assets: {
        title: " của ",
        ...
        modified: 'Đã sửa',
        upload: 'Tải lên',
        noCreations: 'Chưa có video hoặc hình ảnh nào.',
        startCreating: 'Bắt đầu sáng tạo để thấy sản phẩm của bạn ở đây.',
        noUploads: 'Chưa có file nào được tải lên',
        uploadToUse: 'Tải lên file để sử dụng khi tạo nội dung',
        selected: 'đã chọn',
        clear: 'Xóa chọn',
        confirmDelete: 'Bạn có chắc muốn xóa {count} mục đã chọn?',
        deleteError: 'Đã xảy ra lỗi khi xóa mục.',
        newCreation: 'Sáng tạo mới',
      },
      selectFile: {
        title: 'Chọn file từ Tài nguyên',
        noFiles: 'Chưa có file nào được tải lên',
        uploadFirst: 'Vui lòng tải lên file trong Assets trước',
      },
      models: {
        nanoPro: 'Chất lượng ảnh chuyên nghiệp',
        nano: 'Nhanh & hiệu quả',
        sdxl: 'Stable Diffusion chất lượng cao',
        groq: 'Siêu nhanh & thông minh',
        geminiFlash: 'Mô hình nhanh & thông minh nhất',
        geminiNextGen: 'Hiệu năng thế hệ mới',
        geminiPro: 'Suy luận & phức tạp',
        nanoVideo: 'Tạo video mượt mà',
        runway: 'Điện ảnh chân thực',
      },
      chat: {
        back: 'Quay lại',
        history: 'Lịch sử chat',
        startChat: 'Bắt đầu cuộc trò chuyện với Creator AI',
        loadingChat: 'Đang tải đoạn chat...',
        uploadingImage: 'Đang tải file lên...',
        fileUploaded: 'Tải file lên thành công',
        uploadError: 'Lỗi khi tải file lên',
        fileReadError: 'Lỗi khi đọc file',
        thumbsUp: 'Thích',
        thumbsDown: 'Không thích',
        shareTemplate: 'Chia sẻ mẫu',
        newCreation: 'Sáng tạo mới',
        aiTalkingPhoto: 'Ảnh biết nói AI',
        avatarVideo: 'Avatar video',
        productPhoto: 'Product photo',
        vibeMarketing: 'Vibe marketing',
        useNow: 'Sử dụng ngay',
      ...
      recentActivity: {
        ...
        emptyTitle: 'Phòng thu đang yên tĩnh',
        emptyDescription: 'Nhịp đập sáng tạo của bạn đang chờ đợi nhịp đập đầu tiên. Khởi chạy một công cụ để bắt đầu tổng hợp trí tuệ.',
      ...
      studioPulse: {
        title: 'Nhịp Đập Studio',
        noActivity: 'Chưa có hoạt động nào',
        noActivityHint: 'Tạo nội dung để xem nhịp đập studio của bạn tại đây.',
        viewAuditLog: 'Xem Toàn Bộ Nhật Ký',
        activityTypes: {
          contentGenerated: 'NỘI DUNG ĐÃ TẠO',
          creditsUpdated: 'CREDITS ĐÃ CẬP NHẬT',
          newLogin: 'ĐĂNG NHẬP MỚI',
          imageExported: 'ẢNH ĐÃ XUẤT',
        },
        activityDetails: {
          planUpgrade: 'Nâng cấp gói',
          dailyAllowance: 'Đã thêm hạn mức hàng ngày',
    ...
    billing: {
      ...
      starter: {
        ...
        credits: '5',
        features: {
          credits: '5 Tín dụng Miễn phí (Một lần)',
          tools: 'Truy Cập Gemini 3 Flash',
          seo: 'Tạo 1 Ảnh AI (Dùng thử)',
      ...
      pro: {
        ...
        credits: '100',
        priceMonthly: '200.000',
        priceYearly: '1.920.000',
        features: {
          credits: '100 Credits Hàng Tháng',
          reasoning: 'Gemini 3 Pro Reasoning',
          images: 'Tối đa 3 Video hoặc 12 Ảnh Pro',
      ...
      agency: {
        ...
        priceYearly: '5.760.000',
        features: {
          credits: '300 Credits Hàng Tháng',
          unlimited: 'Tối đa 10 Video hoặc 37 Ảnh Pro',
      ...
      business: {
        ...
        priceYearly: '11.520.000',
        desc: 'Cấp độ doanh nghiệp cho đội nhóm lớn.',
        credits: '600',
        features: {
          monthlyCredits: '600 Credits Hàng Tháng',
          yearlyCredits: '7.200 Credits Hàng Năm',
          unlimited: 'Không Giới Hạn Thành Viên',
          support: 'Hỗ Trợ Ưu Tiên 24/7',
      ...
      perMonth: '/ tháng',
      monthlyCreditsLabel: 'Credits / tháng',
    ...
    dashboard: {
      ...
      home: {
        banner: 'Tính năng AI mới hiện đã có! Trải nghiệm sức mạnh của Gemini 2.5',
        mainHeading: 'Bạn sẽ tạo gì hôm nay?',
        placeholderVideo: 'Mô tả video bạn muốn tạo...',
        placeholderImage: 'Mô tả hình ảnh bạn muốn tạo...',
        placeholderText: 'Chủ đề hoặc ý tưởng cho nội dung văn bản...',
        formHintImage: 'Tạo hình ảnh từ văn bản và thành phần',
        formHintVideo: 'Tạo video từ văn bản và tài liệu',
        formHintText: 'Tạo nội dung văn bản từ mô tả của bạn',
        uploadFromComputer: 'Tải lên từ máy tính',
        chooseFromAssets: 'Chọn từ Tài nguyên',
        more: 'Thêm',
        importFromLink: 'Nhập từ liên kết',
        uploadFromDropbox: 'Tải lên từ Dropbox',
        uploadFromPhone: 'Tải lên từ điện thoại',
        scanQr: 'Quét mã QR',
        scanQrDesc: 'Quét để tải ảnh trực tiếp từ điện thoại',
        schedule: 'Lên lịch',
        recentUploads: 'Tệp gửi lên gần đây',
        ...
        recentCreations: 'Sáng tạo gần đây',
        viewAll: 'Xem tất cả',
        autoRatioDesc: 'Chế độ tự động sẽ chọn tỉ lệ tối ưu dựa trên nội dung bạn mô tả.',
      },
      notificationDropdown: {
        title: 'Thông báo',
        filters: {
        ...
        loading: 'Đang tải...',
        noActivity: 'Chưa có hoạt động nào',
        noNotifications: 'Thông báo sẽ xuất hiện ở đây.',
        groups: {
          today: 'Hôm nay',
          thisWeek: 'Tuần này',
          previous: 'Trước đó',
        ...
        videoStatus: {
          ...
          pending: 'Video trong hàng đợi...',
          failed: 'Không thể tạo video',
          completed: 'Video đã được tạo',
        },
        actions: {
          likedPost: 'đã thích bài viết của bạn.',
          startedFollowing: 'bắt đầu theo dõi bạn.',
          commented: 'đã bình luận: "{comment}"',
          notifiedYou: 'đã thông báo cho bạn.',
          friends: 'Bạn bè',
      ...
      chat: {
        ...
        vibeMarketing: 'Marketing cảm xúc',
        useNow: 'Sử dụng ngay',
        newCreation: 'Sáng tạo mới',
      },
      imageStudio: {
      ...
      analytics: {
        title: 'Thống kê',
        freeForNow: 'Miễn phí hiện tại',
        mainHeading: 'Một bảng điều khiển cho tất cả bài viết trên các nền tảng mạng xã hội.',
        byAccount: 'Theo tài khoản',
        byAccountDesc: 'Theo dõi các chỉ số tương tác chính cho từng tài khoản mạng xã hội.',
        byPost: 'Theo bài viết',
        byPostDesc: 'Phân tích dữ liệu theo từng tin, bài viết và thước phim.',
        compare: 'Tổng hợp và so sánh',
        compareDesc: 'Dễ dàng tổng hợp dữ liệu và so sánh hiệu suất bài viết.',
        authorize: 'Cấp quyền',
        summary: 'Tổng quan',
        ...
        followerGrowth: 'Tăng trưởng người theo dõi',
      },
      publisher: {
        title: 'Đăng bài',
        freeForNow: 'Miễn phí hiện tại',
        mainHeading: 'Quản lý bài viết trên các nền tảng xã hội tại một nơi.',
        postMore: 'Đăng nhiều hơn, phát triển nhanh hơn',
        postMoreDesc: 'Mọi thứ bạn cần để tạo, chỉnh sửa và đăng bài để xây dựng thương hiệu trên mạng xã hội.',
        workflow: 'Tối ưu hóa quy trình làm việc',
        workflowDesc: 'Quản lý tất cả nội dung mạng xã hội của bạn tại một nơi.',
        saveTime: 'Tiết kiệm thời gian',
        saveTimeDesc: 'Lên lịch để tự động đăng nội dung bất cứ khi nào bạn muốn.',
        authorize: 'Cấp quyền',
