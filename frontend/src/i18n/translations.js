  ...
  en: {
    ...
    dashboard: {
      ...
      uploadModal: {
        ...
        support: 'Supports: Images (JPG, PNG, GIF, WebP), PDF, Text (TXT, MD, CSV)',
  ...
  vi: {
    ...
    dashboard: {
      ...
      uploadModal: {
        ...
        support: 'Hỗ trợ: Ảnh (JPG, PNG, GIF, WebP), PDF, Text (TXT, MD, CSV)',
      ...
      inspiration: {
        weeklyTopCreators: 'Nhà Sáng Tạo Hàng Tuần',
        industry: 'Ngành',
        duration: 'Thời lượng',
