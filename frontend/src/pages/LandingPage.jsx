    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-gray-900 dark:text-gray-100 font-sans antialiased transition-colors duration-200">
            ...
            <div className="kling-hero min-h-screen flex flex-col relative overflow-hidden justify-center">
                ...
                <nav className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 w-full h-[72px] transition-all duration-300 ${isScrolled
                    ...
                    <div className="hidden xl:flex items-center space-x-1 h-full">
                        ...
                        <button onClick={() => navigate('/pricing')} className="px-4 py-2 text-sm font-medium text-white/90 hover:text-white transition-colors">{t.nav.pricing}</button>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6 reveal-right">
                        ...
                        <h3 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white leading-tight">
                            {t.landing.videoSolution.titlePart1} <span className="italic text-primary">{t.landing.videoSolution.titlePart2}</span>
                        </h3>
                        <p className="text-lg text-gray-600 dark:text-gray-400">
                            {t.landing.videoSolution.desc}
                        </p>
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto bg-slate-50 dark:bg-slate-800/30 rounded-3xl">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="space-y-6 order-2 md:order-1 reveal-left">
                        ...
                        <h3 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white leading-tight">
                            {t.landing.avatarVideo.titlePart1} <span className="italic text-primary">{t.landing.avatarVideo.titlePart2}</span>
                        </h3>
                        <p className="text-lg text-gray-600 dark:text-gray-400">
                            {t.landing.avatarVideo.desc}
                        </p>
                        <button className="bg-black dark:bg-white text-white dark:text-black px-6 py-3 rounded-lg font-medium hover:opacity-80 transition" onClick={handleAuth}>
                            {t.landing.avatarVideo.cta}
                        </button>
                    </div>
                    <div className="rounded-3xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 order-1 md:order-2 reveal-right">
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6 reveal-right">
                        ...
                        <h3 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white leading-tight">
                            {t.landing.imageStudio.titlePart1} <span className="italic text-primary">{t.landing.imageStudio.titlePart2}</span>
                        </h3>
                        <p className="text-lg text-gray-600 dark:text-gray-400">
                            {t.landing.imageStudio.desc}
                        </p>
                        <button className="bg-black dark:bg-white text-white dark:text-black px-6 py-3 rounded-lg font-medium hover:opacity-80 transition" onClick={handleAuth}>
                            {t.landing.imageStudio.cta}
                        </button>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white dark:bg-background-dark">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16 reveal">
                        <h2 className="text-3xl md:text-5xl font-serif mb-4 dark:text-white">{t.landing.smartTools.titlePart1}<br /><span className="italic text-primary">{t.landing.smartTools.titlePart2}</span></h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 hover:shadow-lg transition cursor-pointer group reveal reveal-delay-1" onClick={handleAuth}>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 h-10 line-clamp-2">{t.landing.smartTools.customAvatar.desc}</p>
                            <div className="text-sm font-medium text-gray-900 dark:text-white flex items-center group-hover:text-primary transition">
                                {t.landing.smartTools.tryItNow} <span className="material-symbols-outlined text-sm ml-1">arrow_forward</span>
                            </div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 hover:shadow-lg transition cursor-pointer group reveal reveal-delay-2" onClick={handleAuth}>
                            ...
                            <h4 className="font-bold text-lg mb-1 dark:text-white">{t.landing.smartTools.imageEditor.title}</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 h-10 line-clamp-2">{t.landing.smartTools.imageEditor.desc}</p>
                            <div className="text-sm font-medium text-gray-900 dark:text-white flex items-center group-hover:text-primary transition">
                                {t.landing.smartTools.tryItNow} <span className="material-symbols-outlined text-sm ml-1">arrow_forward</span>
                            </div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 hover:shadow-lg transition cursor-pointer group reveal reveal-delay-3" onClick={handleAuth}>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 h-10 line-clamp-2">{t.landing.smartTools.quickCut.desc}</p>
                            <div className="text-sm font-medium text-gray-900 dark:text-white flex items-center group-hover:text-primary transition">
                                {t.landing.smartTools.tryItNow} <span className="material-symbols-outlined text-sm ml-1">arrow_forward</span>
                            </div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 hover:shadow-lg transition cursor-pointer group reveal reveal-delay-4" onClick={handleAuth}>
                            ...
                            <h4 className="font-bold text-lg mb-1 dark:text-white">{t.landing.smartTools.removeBg.title}</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 h-10 line-clamp-2">{t.landing.smartTools.removeBg.desc}</p>
                            <div className="text-sm font-medium text-gray-900 dark:text-white flex items-center group-hover:text-primary transition">
                                {t.landing.smartTools.tryItNow} <span className="material-symbols-outlined text-sm ml-1">arrow_forward</span>
                            </div>
                        </div>
            ...
            <section className="py-24 bg-white dark:bg-background-dark">
                <div className="max-w-7xl mx-auto px-6 reveal">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-serif dark:text-white">{t.landing.businessImpact.titlePart1} <span className="italic font-light">{t.landing.businessImpact.titlePart2}</span></h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl border border-gray-100 dark:border-gray-700 reveal reveal-delay-1">
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t.landing.businessImpact.item1.desc}</div>
                            <div className="text-5xl font-bold text-primary mb-6">{t.landing.businessImpact.item1.val}</div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl border border-gray-100 dark:border-gray-700 reveal reveal-delay-2">
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t.landing.businessImpact.item2.desc}</div>
                            <div className="text-5xl font-bold text-primary mb-6">{t.landing.businessImpact.item2.val}</div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl border border-gray-100 dark:border-gray-700 reveal reveal-delay-3">
                            <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t.landing.businessImpact.item3.desc}</div>
                            <div className="text-5xl font-bold text-primary mb-6">{t.landing.businessImpact.item3.val}</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 max-w-5xl mx-auto px-6 reveal">
                <h2 className="text-3xl md:text-5xl font-serif text-center mb-12 dark:text-white">{t.landing.freeTrial.titlePart1} <span className="italic">{t.landing.freeTrial.titlePart2}</span><br />{t.landing.freeTrial.titlePart3} <span className="italic">{t.landing.freeTrial.titlePart4}</span></h2>
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row">
                    <div className="p-10 md:w-1/2 flex flex-col justify-center reveal-left">
                        <div className="text-3xl font-bold mb-6 dark:text-white">{t.landing.freeTrial.price}</div>
                        <ul className="space-y-4 mb-8">
                            <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                                <span className="text-primary mr-2">✓</span> {t.landing.freeTrial.item1}
                            </li>
                            <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                                <span className="text-primary mr-2">✓</span> {t.landing.freeTrial.item2}
                            </li>
                            <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                                <span className="text-primary mr-2">✓</span> {t.landing.freeTrial.item3}
                            </li>
                            <li className="flex items-start text-sm text-gray-600 dark:text-gray-300">
                                <span className="text-primary mr-2">✓</span> {t.landing.freeTrial.item4}
                            </li>
                        </ul>
                        ...
                        <div className="absolute bottom-8 left-8 right-8">
                            <div className="bg-white/20 backdrop-blur-md border border-white/30 p-4 rounded-xl text-white">
                                <div className="flex items-center space-x-2 mb-2">
                                    ...
                                    <span className="text-xs font-bold">{t.landing.freeTrial.generating}</span>
                                </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-16">
                        <div className="col-span-1 md:col-span-1">
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <span className="font-brand font-bold text-lg tracking-tight">Creator AI</span>
                            </div>
                        ...
                        <div>
                            <h4 className="font-bold mb-4 text-sm">{t.footer.solutions}</h4>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                <li><button className="hover:text-white" onClick={() => navigate('/terms')}>{t.footer.termsOfService}</button></li>
                                <li><button className="hover:text-white" onClick={() => navigate('/privacy')}>{t.footer.privacyPolicy}</button></li>
                            </ul>
                        </div>
                    </div>
                    <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                        <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-4 md:mb-0">
                            <button className="hover:text-gray-300" onClick={() => navigate('/terms')}>{t.footer.termsOfService}</button>
                            <button className="hover:text-gray-300" onClick={() => navigate('/privacy')}>{t.footer.privacyPolicy}</button>
                        </div>
                        <div>
                            {t.footer.bottomTagline} <button className="text-primary ml-1 hover:underline" onClick={handleAuth}>{t.footer.signUpFree}</button>
                        </div>
                    </div>
                </div>
            </footer>
